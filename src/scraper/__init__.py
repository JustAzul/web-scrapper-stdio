...
def extract_clean_html(html_content, elements_to_remove, url):
    """Clean and parse HTML and return sanitized body HTML.
    ...
    -------
    tuple
        A tuple of ``(title, clean_html, error)`` where ``error`` is ``None`` when extraction succeeds.
    """
    ...
    return page_title, clean_html, None
    ...
    try:
        async with async_playwright() as p:
            ...
            try:
                ...
                page_title, clean_html, content_error = extract_clean_html(
                ...
                text_content = to_text(clean_html)
                ...
                if output_format is OutputFormat.TEXT:
                    ...
                    formatted = format_content(clean_html, output_format)
