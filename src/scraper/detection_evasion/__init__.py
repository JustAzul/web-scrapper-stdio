...
This module implements anti-detection measures to avoid bot detection
...
# Public API for the detection_evasion module
__all__ = [
...
def create_stealth_config() -> AntiDetectionConfig:
    """Create configuration for maximum stealth."""
...
def create_performance_config() -> AntiDetectionConfig:
    """Create configuration for performance with minimal anti-detection."""
    return AntiDetectionConfig(
        enable_user_agent_rotation=True,
